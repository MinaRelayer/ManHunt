...
public class HelpCommand {
    ...
    public int execute(CommandSender sender) {
        ...
        sender.sendMessage(this.langManager.getComponent("help-player-header", new Object[0]));
        ...
        if (sender.hasPermission("manhunt.admin")) {
            sender.sendMessage(this.langManager.getComponent("help-admin-header", new Object[0]));
            sender.sendMessage(this.langManager.getComponent("help-runner-target", new Object[0]));
            sender.sendMessage(this.langManager.getComponent("help-hunter-target", new Object[0]));
            sender.sendMessage(this.langManager.getComponent("help-spectator-target", new Object[0]));
