...
- Hunters receive an enchanted compass that tracks the nearest Runner; it can move in the inventory/offhand, but cannot be dropped or placed in containers.
...
1. Build or download `ManHunt-1.0.3.jar`.
